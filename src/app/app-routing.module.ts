...
import { InfiniteScrollingListComponent } from './pages/lists/infinite-scrolling-list/infinite-scrolling-list.component';
...
const routes: Routes = [
  ...
  { path: 'lists/infinite-scrolling', component: InfiniteScrollingListComponent, data: { title: 'Infinite Scrolling List Page' } }
];
